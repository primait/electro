...
readonly git_path="https://github.com/primait/electro.git"
...
killall_fswatch() {
    ...
    # TODO: ricordarsi killare anche gli fswatch
    set -e
}
...
watch() {
    ...
    local project
    project=get_project
    logfile="${log_path}$(project).log"
    pidfile="${log_path}$(project).pid"
